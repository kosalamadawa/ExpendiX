//
//  EXIncomeCategorySheetView.swift
//  ExpendiX
//
...
struct EXIncomeCategorySheetView: View {
    var showSheet: Bool
        ...
        VStack {
            ...
            VStack {
                ...
                ScrollView(.vertical, showsIndicators: false) {
                    VStack(spacing: 10) {
                        ForEach(EXIncomeCategory.allCases, id: \.self) {category in
                            HStack(spacing: 16) {
...
struct EXIncomeCategorySheetView_Previews: PreviewProvider {
    static var previews: some View {
        EXIncomeCategorySheetView(showSheet: true, selectCategory: { selectedCategory in
